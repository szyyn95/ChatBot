...
This file contains the code to build the kernel seq2seq model. This model is also a derivation of the
famous Google neural translate model.

This file has been modified to run under Tensorflow 1.2 and Python 3.6. If you face any bug regarding
Tensorflow API issue, please check your Tensorflow version. 

For Anaconda users: Please create a virtual environment with Tensorflow 1.2 and Python 3.6 to successfully
run this model unless you have the right version in your root environment.
"""
